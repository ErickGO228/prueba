      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <h2 class="display-3 text-black">Muchas Gracias por comprar en Titotech !</h2>
            <p class="lead mb-5">Su orden se ha acompletado correctamente .</p>
            <p><a href="tienda.html" class="btn btn-sm btn-primary">Regresar a la Tienda </a></p>
            <p><a href="index.php" class="btn btn-sm btn-primary">Revisa otros productos  </a></p>
          </div>
          </div>
        </div>
      </div>
